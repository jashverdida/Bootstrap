...
<body>
		...
		<!-- Hero Section -->
		<section class="text-white py-5 position-relative overflow-hidden" style="min-height: 600px;">
			<img src="https://plus.unsplash.com/premium_photo-1677486561598-0afa3cefc838?q=80&w=701&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
				 class="position-absolute top-0 start-0 w-100 h-100" 
				 style="object-fit: cover; z-index: 1;" 
				 alt="Modern workspace">
			<div class="position-absolute top-0 start-0 w-100 h-100" style="background: linear-gradient(135deg, rgba(159, 159, 159, 0.8), rgba(102, 126, 234, 0.8)); z-index: 2;"></div>
			...
			<div class="container">
				<div class="row align-items-center mb-5">
					<div class="col-lg-6 order-lg-2">
						<img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" class="img-fluid rounded shadow" alt="Analytics Dashboard">
					</div>
				...
				<div class="row align-items-center">
					<div class="col-lg-6">
						<img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" class="img-fluid rounded shadow" alt="Team Collaboration">
					</div>
					<div class="col-lg-6">
						<div class="ps-lg-5">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-2 col-md-6">
						...
						<p class="text-light small">Stay updated with the latest Bootstrap news and releases.</p>
